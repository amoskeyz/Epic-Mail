...
router.delete('/groups/:groupId/users/:userId', authenticator.authenticateUser, groupController.deleteUser);
router.post('/groups/:groupId/messages', authenticator.authenticateUser, groupController.messageGroup);
